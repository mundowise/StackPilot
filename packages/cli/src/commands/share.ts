/**
 * forgeboard share <stackId> — Generate a shareable URL for a saved stack.
 * forgeboard import-url <url> — Import a stack from a share URL.
 *
...
export const shareCommand = new Command("share")
  ...
  .option("--base-url <url>", "Custom base URL", "https://forgeboard.dev/s/#")
  .action((id: string, opts) => {
    ...
    const content = [
      ...
      `  import it with:`,
      `  ${chalk.white("forgeboard import-url <url>")}`,
      "",
...
export const importUrlCommand = new Command("import-url")
  ...
  .argument("<url>", "Share URL generated by forgeboard share")
  ...
  .action((url: string, opts) => {
    ...
    try {
      ...
      console.error(
        chalk.red("Invalid share URL. Expected format: https://forgeboard.dev/s/#<data>"),
      );
      process.exit(1);
    }
